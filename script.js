document.addEventListener('DOMContentLoaded', function() {
    ...
    // Botón flotante de Mavilda - posicionado arriba del botón de WhatsApp
    ...
    // Event listeners para el botón de Mavilda
    mavildasButton.addEventListener('mouseenter', () => {
        mavildasButton.style.transform = 'scale(1.1)';
        mavildasButton.style.boxShadow = '0 6px 20px rgba(76, 175, 80, 0.6)';
    });

    mavildasButton.addEventListener('mouseleave', () => {
        mavildasButton.style.transform = 'scale(1)';
        mavildasButton.style.boxShadow = '0 4px 12px rgba(76, 175, 80, 0.4)';
    });

    // Función para abrir chat de Mavilda
    mavildasButton.addEventListener('click', () => {
        // Crear overlay para el chat
        ...
        chatHeader.innerHTML = `
            <div style="display: flex; align-items: center; gap: 10px;">
                <img src="attached_assets/mavilda-bot.png" alt="Mavilda" style="width: 30px; height: 30px; border-radius: 50%; object-fit: cover;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                <div style="display: none;">🤖</div>
                <div>
                    <div style="font-weight: bold;">Mavilda • Seragro</div>
                    <div style="font-size: 12px; opacity: 0.9;">Asesora DJI</div>
                </div>
            </div>
            <button id="closeChat" style="background: none; border: none; color: white; font-size: 20px; cursor: pointer;">×</button>
        `;

        // Cuerpo del chat - iframe con el widget
        ...
        chatBody.innerHTML = `
            <iframe src="https://Mavilda-SERagro.replit.app/chat" 
    ...
    // Agregar el botón de Mavilda al DOM
