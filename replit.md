...
- Mobile horizontal positioning: WhatsApp at 30px from right, Mavilda at 40px from right
...
- Cache-busting version updated to v=1760119309 (JS and CSS)
- Fixed CSS !important override issue in style.css for mobile button positioning
- Floating buttons optimized for mobile: WhatsApp at 30px from edge, Mavilda at 40px from edge
